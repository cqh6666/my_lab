...
test_x = pd.read_feather('/panfs/pfs.local/work/liu/xzhang_sta/tangxizhuo/data/24h_test_x_by_year.feather')
test_y = pd.read_feather('/panfs/pfs.local/work/liu/xzhang_sta/tangxizhuo/data/24h_test_y_by_year.feather')['Label']
...
print("the idx range is:", start_idx, end_idx)
...
test_result.to_csv(f'/panfs/pfs.local/work/liu/xzhang_sta/tangxizhuo/pg/test_result/0009_proba_01_001_005-1-tran_{start_idx}.csv', index=True)
# p_weight.to_csv(f'/panfs/pfs.local/work/liu/xzhang_sta/tangxizhuo/pg/test_result/0009_weight_01_001_005-1_{start_idx}.csv', index=True)
