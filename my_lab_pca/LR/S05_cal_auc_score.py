...
for comp in pca_comps:
    # S05_auto_encoder_lr_test_tra0_dim20_v3.csv
    res = pd.read_csv(f"./result/history_log/S05_auto_encoder_lr_test_tra1_dim{comp}_v{version}.csv")
    no_res = pd.read_csv(f"./result/history_log/S05_auto_encoder_lr_test_tra0_dim{comp}_v{version}.csv")
