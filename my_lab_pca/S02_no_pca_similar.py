...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="train personalized model by different models")
    ...
    with open(f'./result/S02_test_similar_patient_ids_{model_name}.pkl', 'wb') as file:
        pickle.dump(test_similar_patient_ids, file)

    # save result csv
    test_result.to_csv(f"./result/S02_test_result_{model_name}.csv")
