...
# S05_auto_encoder_xgb_test_tra0_v1.csv
res = pd.read_csv(f"./result/S05_auto_encoder_xgb_test_tra1_v{version}.csv")
no_res = pd.read_csv(f"./result/S05_auto_encoder_xgb_test_tra0_v{version}.csv")
