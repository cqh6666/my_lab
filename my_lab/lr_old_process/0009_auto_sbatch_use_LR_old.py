...
iteration_idx = 30
step = 5
PSM_SAVE_PATH = f'/panfs/pfs.local/work/liu/xzhang_sta/chenqinhai/result/personal_model_with_lr/{pre_hour}h_old/no_transfer_psm_liblinear/'
...
while iteration_idx <= 120:
    ...
    if os.path.exists(psm_no_transfer_file_name):
        my_logger.info(f"{psm_no_transfer_file_name} exist, start sbatch 0009_auto_sbatch_LR.sh {iteration_idx}...")
        time.sleep(20)
        os.system(
